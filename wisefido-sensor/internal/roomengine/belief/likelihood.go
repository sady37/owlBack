...
func rawLikelihood(o Observation) Vector {
	...
	case ObsDwellStill:
		...
		// 开阔地 cell tolerance 拉长尾 + P4.3 夜间短尾 + 雷达远边缘 ×1.5）。open 12min(base)；bed/enter/unknown 不报。
		fallLR := fallLRFromDwell(o.Value, o.ToleranceFactor, o.RoomType, o.AreaType, o.Night, o.RadarDistCm)
		if fallLR <= 1.0 {
