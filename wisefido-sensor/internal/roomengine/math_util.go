...
// 夜间时段默认 22:00 - 06:30 本地时间（可由 RiskTimeConfig 覆盖）。
// 设计动机：
...
// 2026-06-06 默认从 23:30-07:30 提前到 22:00-06:30：美国老人睡眠相位前移
// （advanced sleep phase，典型就寝 21-22 点 / 清醒 05-06 点），起夜跌倒高发期更早。
const (
	defaultNightStartH = 22
	defaultNightStartM = 0
	defaultNightEndH   = 6
	defaultNightEndM   = 30
)
