...
func (h *AuthV2Handler) findActiveUser(ctx context.Context, user_account, passwordHashHex, tenantPrefix string) (*userRow, error) {
	// 状态门槛（用 OR 组合）：
...
func (h *AuthV2Handler) searchTenantsByCredentials(ctx context.Context, user_account, passwordHashHex string) ([]v2TenantMatch, error) {
...
func (h *AuthV2Handler) recordLoginFailure(ctx context.Context, user_account string) {
	if user_account == "" {
		return
	}
