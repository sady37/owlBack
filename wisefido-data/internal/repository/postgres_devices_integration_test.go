...
func TestPostgresDeviceStoreRepo_CreateDeviceStore(t *testing.T) {
	...
	repo := NewPostgresDeviceStoreRepository(db)
	ctx := context.Background()

	// 测试：创建设备库存
	deviceStore := &domain.DeviceStore{
		DeviceType:      "Radar",
		DeviceModel:     sql.NullString{String: "WF-RADAR-60G-V2", Valid: true},
		SerialNumber:    sql.NullString{String: "TEST-SN-001", Valid: true},
		UID:             sql.NullString{String: "TEST-UID-001", Valid: true},
		IMEI:            sql.NullString{String: "123456789012345", Valid: true},
		CommMode:        sql.NullString{String: "WiFi", Valid: true},
		MCUModel:        sql.NullString{String: "ESP32", Valid: true},
		FirmwareVersion: sql.NullString{String: "1.0.0", Valid: true},
		TenantID:        "00000000-0000-0000-0000-000000000000",
		AllowAccess:     true,
	}

	deviceStoreID, err := repo.CreateDeviceStore(ctx, deviceStore)
	if err != nil {
...
func TestPostgresDeviceStoreRepo_GetDeviceStore(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-002", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-002", Valid: true},
		TenantID:     "00000000-0000-0000-0000-000000000000",
		AllowAccess:  true,
	}
...
func TestPostgresDeviceStoreRepo_DeleteDeviceStore(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-003", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-003", Valid: true},
		TenantID:     "00000000-0000-0000-0000-000000000000",
		AllowAccess:  true,
	}
...
func TestPostgresDeviceStoreRepo_DeleteDeviceStore_WithAllocation(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-004", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-004", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
...
func TestPostgresDevicesRepo_CreateDevice(t *testing.T) {
	...
	repo := NewPostgresDevicesRepository(db)
	ctx := context.Background()
	tenantID := createTestTenantForDevices(t, db)
	defer cleanupTestDataForDevices(t, db, tenantID)

	// 先创建一个已分配的device_store
	deviceStoreRepo := NewPostgresDeviceStoreRepository(db)
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-005", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-005", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
	if err != nil {
		t.Fatalf("CreateDeviceStore failed: %v", err)
	}
	defer db.Exec(`DELETE FROM device_store WHERE device_store_id = $1`, deviceStoreID)
...
func TestPostgresDevicesRepo_CreateDevice_WithRoomBinding(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-006", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-006", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
...
func TestPostgresDevicesRepo_DeleteDevice(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-007", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-007", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
...
func TestPostgresDevicesRepo_CreateDevice_UnallocatedDeviceStore(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-008", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-008", Valid: true},
		TenantID:     "00000000-0000-0000-0000-000000000000",
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
	...
	device := &domain.Device{
		DeviceStoreID: sql.NullString{String: deviceStoreID, Valid: true},
		DeviceName:    "Test Device 008",
	}

	_, err = repo.CreateDevice(ctx, tenantID, device)
	if err == nil {
...
func TestPostgresDevicesRepo_ListDevices(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-LIST-001", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-LIST-001", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
	...
	device := &domain.Device{
		DeviceStoreID: sql.NullString{String: deviceStoreID, Valid: true},
		DeviceName:    "Test Device List 001",
	}
	deviceID, err := repo.CreateDevice(ctx, tenantID, device)
	if err != nil {
		t.Fatalf("CreateDevice failed: %v", err)
	...
	devices, total, err := repo.ListDevices(ctx, tenantID, filters, 1, 20)
	if err != nil {
...
func TestPostgresDevicesRepo_UpdateDevice(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-UPDATE-001", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-UPDATE-001", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
	...
	device := &domain.Device{
		DeviceStoreID: sql.NullString{String: deviceStoreID, Valid: true},
		DeviceName:    "Test Device Update 001",
	}
	deviceID, err := repo.CreateDevice(ctx, tenantID, device)
	if err != nil {
		t.Fatalf("CreateDevice failed: %v", err)
	...
	// 测试：更新设备
	updateDevice := &domain.Device{
		DeviceName:     "Updated Device Name",
		BusinessAccess: "approved",
		Status:         "online",
	}
	err = repo.UpdateDevice(ctx, tenantID, deviceID, updateDevice)
	if err != nil {
...
func TestPostgresDevicesRepo_DisableDevice(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-DISABLE-001", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-DISABLE-001", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
	...
	device := &domain.Device{
		DeviceStoreID: sql.NullString{String: deviceStoreID, Valid: true},
		DeviceName:    "Test Device Disable 001",
	}
	deviceID, err := repo.CreateDevice(ctx, tenantID, device)
	if err != nil {
		t.Fatalf("CreateDevice failed: %v", err)
	...
	filters := DeviceFilters{}
	devices, _, err := repo.ListDevices(ctx, tenantID, filters, 1, 20)
	if err != nil {
		t.Fatalf("ListDevices failed: %v", err)
	}
	for _, d := range devices {
...
func TestPostgresDevicesRepo_GetOrCreateDeviceFromStore(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-AUTO-001", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-AUTO-001", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
...
func TestPostgresDevicesRepo_GetDevice(t *testing.T) {
	...
	deviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-GET-001", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-GET-001", Valid: true},
		TenantID:     tenantID,
		AllowAccess:  true,
	}
	deviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, deviceStore)
	...
	// 先为另一个租户创建设备
	otherDeviceStore := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-GET-002", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-GET-002", Valid: true},
		TenantID:     otherTenantID,
		AllowAccess:  true,
	}
	otherDeviceStoreID, err := deviceStoreRepo.CreateDeviceStore(ctx, otherDeviceStore)
	if err != nil {
	...
	otherDeviceID, err := repo.CreateDevice(ctx, otherTenantID, otherDevice)
	if err != nil {
...
func TestPostgresDeviceStoreRepo_ListDeviceStores(t *testing.T) {
	...
	// 创建测试数据
	deviceStore1 := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-LIST-001", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-LIST-001", Valid: true},
		TenantID:     tenantID,
	...
	deviceStoreID1, err := repo.CreateDeviceStore(ctx, deviceStore1)
	if err != nil {
		t.Fatalf("CreateDeviceStore failed: %v", err)
	}
	...
	deviceStore2 := &domain.DeviceStore{
		DeviceType:   "SleepPad",
		SerialNumber: sql.NullString{String: "TEST-SN-LIST-002", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-LIST-002", Valid: true},
		TenantID:     "00000000-0000-0000-0000-000000000000",
		AllowAccess:  true,
	}
	deviceStoreID2, err := repo.CreateDeviceStore(ctx, deviceStore2)
	if err != nil {
		t.Fatalf("CreateDeviceStore failed: %v", err)
	}
	...
	items, total, err := repo.ListDeviceStores(ctx, filters, 1, 20)
	if err != nil {
...
func TestPostgresDeviceStoreRepo_BatchUpdateDeviceStores(t *testing.T) {
	...
	deviceStore1 := &domain.DeviceStore{
		DeviceType:   "Radar",
		SerialNumber: sql.NullString{String: "TEST-SN-BATCH-001", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-BATCH-001", Valid: true},
		TenantID:     "00000000-0000-0000-0000-000000000000",
		AllowAccess:  true,
	}
	deviceStoreID1, err := repo.CreateDeviceStore(ctx, deviceStore1)
	...
	deviceStore2 := &domain.DeviceStore{
		DeviceType:   "SleepPad",
		SerialNumber: sql.NullString{String: "TEST-SN-BATCH-002", Valid: true},
		UID:          sql.NullString{String: "TEST-UID-BATCH-002", Valid: true},
		TenantID:     "00000000-0000-0000-0000-000000000000",
		AllowAccess:  true,
	}
	deviceStoreID2, err := repo.CreateDeviceStore(ctx, deviceStore2)
	...
	updates := []*domain.DeviceStore{
		{
			DeviceStoreID:            deviceStoreID1,
			TenantID:                 tenantID,
			OTATargetFirmwareVersion: sql.NullString{String: "2.0.0", Valid: true},
			OTATargetMCUModel:        sql.NullString{String: "ESP32-V2", Valid: true},
			AllowAccess:              true,
		},
		{
			DeviceStoreID:            deviceStoreID2,
			TenantID:                 tenantID,
			OTATargetFirmwareVersion: sql.NullString{String: "1.5.0", Valid: true},
			AllowAccess:              false,
		},
	}
...
func TestPostgresDeviceStoreRepo_ImportDeviceStores(t *testing.T) {
	...
	// 测试：批量导入设备库存
	items := []*domain.DeviceStore{
		{
			DeviceType:   "Radar",
			SerialNumber: sql.NullString{String: "TEST-SN-IMPORT-001", Valid: true},
			UID:          sql.NullString{String: "TEST-UID-IMPORT-001", Valid: true},
			DeviceModel:  sql.NullString{String: "WF-RADAR-60G-V2", Valid: true},
			TenantID:     tenantID, // 使用tenantID而不是tenant_name
		},
		{
			DeviceType:   "SleepPad",
			SerialNumber: sql.NullString{String: "TEST-SN-IMPORT-002", Valid: true},
			UID:          sql.NullString{String: "TEST-UID-IMPORT-002", Valid: true},
			DeviceModel:  sql.NullString{String: "WF-SLEEPPAD-V1", Valid: true},
			TenantID:     "00000000-0000-0000-0000-000000000000",
		},
		{
			DeviceType:   "Radar",
			SerialNumber: sql.NullString{String: "TEST-SN-IMPORT-003", Valid: true},
			UID:          sql.NullString{String: "TEST-UID-IMPORT-003", Valid: true},
			TenantID:     "00000000-0000-0000-0000-000000000000",
		},
	}

	successCount, skipped, errors, err := repo.ImportDeviceStores(ctx, items)
	if err != nil {
	...
	importedItems, _, err := repo.ListDeviceStores(ctx, filters, 1, 20)
	if err != nil {
		t.Fatalf("ListDeviceStores failed: %v", err)
	}
