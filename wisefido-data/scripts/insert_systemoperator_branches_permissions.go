...
func main() {
	...
	// 插入 SystemOperator 的 branches 权限
	permissions := []struct {
		resourceType   string
	...
	fmt.Fprintf(os.Stdout, "\n✅ Successfully inserted SystemOperator branches permissions\n")
}
