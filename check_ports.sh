...
echo "  PostgreSQL 端口映射: 5432:5432"
...
grep -n "5432" /Users/sady3721/project/owlBack/wisefido-radar/internal/config/config.go | head -3
echo ""
...
echo "2. 测试连接: nc -zv localhost 5432"
