...
import "owl-common/snomed"

// GetSNOMEDMappingByFieldPath 无转换表时返回 nil，使用原始值（备用，可后续接入 radar_convert_table 等）
func GetSNOMEDMappingByFieldPath(fieldPath string, rawValue interface{}) (*snomed.SNOMEDMapping, error) {
	return nil, nil
}
...
func ApplySNOMEDMappingInternal(encoded map[string]interface{}, fieldName, fieldPath string, rawValue interface{}, getMappingFunc func(string, interface{}) (*snomed.SNOMEDMapping, error)) {
