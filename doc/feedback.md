...
- **last-audited**:`a04a64c`(委员会 R6 收 **bedside FN 止血部署 test1 + geom 退役映射表交付**:止血 `5ef9ede` 已部署(DBN_MODE=2,e2e 随批 4 补);映射表 plan `a04a64c`(`doc/geom_retirement_mapping.md`)逐条覆盖四块,4 待签字 D1-D4(D4 GeomConf provenance blend 风险最高)。详见 `doc/feedback_p4.md`)
